...
let print_symbol = function
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_STACK) -> "stack_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_POLY) -> "poly_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_MOD) -> "mod"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_LBRACKETCOLON) -> "[:"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_LAYOUT) -> "layout_"
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_LABEL) -> "label"
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_KIND_OF) -> "kind_of_"
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_KIND) -> "kind_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_HASHTRUE) -> "#true"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_HASHFALSE) -> "#false"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_COLONRBRACKET) -> ":]"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_BORROW) -> "borrow_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_value_constant) -> "value_constant"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_type_trailing_hash) -> "type_trailing_hash"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_signed_value_constant) -> "signed_value_constant"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_reversed_separated_nonempty_llist_AND_comprehension_clause_binding_) -> "reversed_separated_nonempty_llist_AND_comprehension_clause_binding_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_reversed_nonempty_llist_typevar_repr_) -> "reversed_nonempty_llist_typevar_repr_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_reversed_nonempty_llist_mkrhs_ident__) -> "reversed_nonempty_llist_mkrhs_ident__"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_poly_flag) -> "poly_flag"
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_payload) -> "payload"
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_pattern_with_modes_or_poly) -> "pattern_with_modes_or_poly"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_optional_poly_type_and_modes) -> "optional_poly_type_and_modes"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_mutable_or_global_flag) -> "mutable_or_global_flag"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_module_name_modal_atat_modalities_expr_) -> "module_name_modal_atat_modalities_expr_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_module_declaration_body_module_type_with_optional_modes_) -> "module_declaration_body_module_type_with_optional_modes_"
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_module_declaration_body___anonymous_8_) -> "module_declaration_body___anonymous_8_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_include_kind) -> "include_kind"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_fun_seq_expr) -> "fun_seq_expr"
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_fun_params) -> "fun_params"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_comprehension_iterator) -> "comprehension_iterator"
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_comprehension_clause_binding) -> "comprehension_clause_binding"
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_comprehension_clause) -> "comprehension_clause"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_atat_modalities_expr) -> "atat_modalities_expr"
...
let print_value (type a) : a MenhirInterpreter.symbol -> a -> string = function
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_STACK -> (fun _ -> "stack_")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_POLY -> (fun _ -> "poly_")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_MOD -> (fun _ -> "mod")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_LBRACKETCOLON -> (fun _ -> "[:")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_LAYOUT -> (fun _ -> "layout_")
  | MenhirInterpreter.T MenhirInterpreter.T_LABEL -> (Printf.sprintf "LABEL(%S)")
  | MenhirInterpreter.T MenhirInterpreter.T_KIND_OF -> (fun _ -> "kind_of_")
  | MenhirInterpreter.T MenhirInterpreter.T_KIND -> (fun _ -> "kind_")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_HASHTRUE -> (fun _ -> "#true")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_HASHFALSE -> (fun _ -> "#false")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_COLONRBRACKET -> (fun _ -> ":]")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_BORROW -> (fun _ -> "borrow_")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_value_constant -> (fun _ -> "value_constant")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_type_trailing_hash -> (fun _ -> "type_trailing_hash")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_signed_value_constant -> (fun _ -> "signed_value_constant")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_reversed_separated_nonempty_llist_AND_comprehension_clause_binding_ -> (fun _ -> "reversed_separated_nonempty_llist_AND_comprehension_clause_binding_")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_reversed_nonempty_llist_typevar_repr_ -> (fun _ -> "reversed_nonempty_llist_typevar_repr_")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_reversed_nonempty_llist_mkrhs_ident__ -> (fun _ -> "reversed_nonempty_llist_mkrhs_ident__")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_reversed_labeled_tuple_body -> (fun _ -> "reversed_labeled_tuple_body")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_poly_flag -> (fun _ -> "poly_flag")
  | MenhirInterpreter.N MenhirInterpreter.N_payload -> (fun _ -> "payload")
  | MenhirInterpreter.N MenhirInterpreter.N_pattern_with_modes_or_poly -> (fun _ -> "pattern_with_modes_or_poly")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_optional_poly_type_and_modes -> (fun _ -> "optional_poly_type_and_modes")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_mutable_or_global_flag -> (fun _ -> "mutable_or_global_flag")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_module_type_atomic -> (fun _ -> "module_type_atomic")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_module_name_modal_atat_modalities_expr_ -> (fun _ -> "module_name_modal_atat_modalities_expr_")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_module_declaration_body_module_type_with_optional_modes_ -> (fun _ -> "module_declaration_body_module_type_with_optional_modes_")
  | MenhirInterpreter.N MenhirInterpreter.N_module_declaration_body___anonymous_8_ -> (fun _ -> "module_declaration_body___anonymous_8_")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_include_kind -> (fun _ -> "include_kind")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_fun_seq_expr -> (fun _ -> "fun_seq_expr")
  | MenhirInterpreter.N MenhirInterpreter.N_fun_params -> (fun _ -> "fun_params")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_comprehension_iterator -> (fun _ -> "comprehension_iterator")
  | MenhirInterpreter.N MenhirInterpreter.N_comprehension_clause_binding -> (fun _ -> "comprehension_clause_binding")
  | MenhirInterpreter.N MenhirInterpreter.N_comprehension_clause -> (fun _ -> "comprehension_clause")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_atat_modalities_expr -> (fun _ -> "atat_modalities_expr")
...
let print_token = function
  ...
  | STACK -> print_value (MenhirInterpreter.T MenhirInterpreter.T_STACK) ()
  ...
  | POLY -> print_value (MenhirInterpreter.T MenhirInterpreter.T_POLY) ()
  ...
  | MOD -> print_value (MenhirInterpreter.T MenhirInterpreter.T_MOD) ()
  ...
  | LBRACKETCOLON -> print_value (MenhirInterpreter.T MenhirInterpreter.T_LBRACKETCOLON) ()
  ...
  | LAYOUT -> print_value (MenhirInterpreter.T MenhirInterpreter.T_LAYOUT) ()
  | LABEL v -> print_value (MenhirInterpreter.T MenhirInterpreter.T_LABEL) v
  | KIND_OF -> print_value (MenhirInterpreter.T MenhirInterpreter.T_KIND_OF) ()
  | KIND -> print_value (MenhirInterpreter.T MenhirInterpreter.T_KIND) ()
  ...
  | HASHTRUE -> print_value (MenhirInterpreter.T MenhirInterpreter.T_HASHTRUE) ()
  ...
  | HASHFALSE -> print_value (MenhirInterpreter.T MenhirInterpreter.T_HASHFALSE) ()
  ...
  | COLONRBRACKET -> print_value (MenhirInterpreter.T MenhirInterpreter.T_COLONRBRACKET) ()
  ...
  | BORROW -> print_value (MenhirInterpreter.T MenhirInterpreter.T_BORROW) ()
...
let token_of_terminal (type a) (t : a MenhirInterpreter.terminal) (v : a) : token =
  ...
  | MenhirInterpreter.T_LBRACKETCOLON -> LBRACKETCOLON
  ...
  | MenhirInterpreter.T_LAYOUT -> LAYOUT
  | MenhirInterpreter.T_LABEL -> LABEL v
  | MenhirInterpreter.T_KIND_OF -> KIND_OF
  | MenhirInterpreter.T_KIND -> KIND
  ...
  | MenhirInterpreter.T_COLONRBRACKET -> COLONRBRACKET
  ...
  | MenhirInterpreter.T_BORROW -> BORROW
