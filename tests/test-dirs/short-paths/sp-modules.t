...
> -log-file - -log-section short-paths -filename substs.ml < substs.ml 
  ...
  [] :> A: [A/285[2];
          W/290[1].A] :> B: [A/285[2].B;
                           W/290[1].A.B] :> C: [A/285[2].B.C;
                                              W/290[1].A.B.C] :> t: [A/285[2].B.C.t;
                                                                   W/290[1].A.B.C.t] :> 
  B: [B/283[3]] :> C: [B/283[3].C] :> t: [B/283[3].C.t] :> 
  C: [C/282[4]] :> t: [C/282[4].t] :> M: [M/289[7]] :> 
  N: [N/288[6]] :> C: [N/288[6].C] :> 
  W: [W/290[1]] :> A: [W/290[1].A] :> B: [W/290[1].A.B] :> C: [W/290[1].A.B.C] :> 
                                                             t: [W/290[1].A.B.C.t] :> 
    M: [W/290[1].M] :> 
    N: [W/290[1].N] :> t: [t/281[5]] :>  A/285[2].B -> [N/288[6]];
